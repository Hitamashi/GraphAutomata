...
public class GraphFrame extends JFrame {
	...
	protected FramesController controller;
	...
	protected JButton addShapeButton(JToolBar toolbar, final RectangularShape sample, String name) {
	...
	protected void createMenuSeparator(JMenu menu) {
